...
<label style="color:red;margin-left:10px;font-weight:bold;box-shadow: 5px 5px 10px #666;">News</label>

<br><br>
<div style="color:white;background:#6B3B85;width:auto;height:100;background:url('images/contact1.jpg');"
...
<div id="outPutContainer" style="color:red;width:1500;height:100;background:url('images/contact.jpg');"></div>
...
<script>
 ...
 document.getElementById("fa2").className="active";
