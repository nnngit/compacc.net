...
<label id=divarrow>Timeline</label>

<body>
<button onClick="scrollToBottom()" style=float:right>Scroll to Bottom</button>
<a href="#end" onClick="scrollToBottom()" style=float:right>Bottom</a>
...
<a href=# onClick="scrollToTop()" style=float:right>Top</a>
...
<script>
 ...
 document.getElementById("fa5").className="active";
